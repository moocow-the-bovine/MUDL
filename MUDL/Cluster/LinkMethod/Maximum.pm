##
## File: MUDL::Cluster::LinkMethod::Maximum.pm
## Author: Bryan Jurish <moocow@ling.uni-potsdam.de>
## Description:
##  + MUDL: generic clustering (cluster-row & cluster-cluster) distance linkage, native perl: maximum-link
##======================================================================

package MUDL::Cluster::LinkMethod::Maximum;
...
sub compare_link {
  ...
  my ($lwhich,$lcmps) = ccs_accum_maximum($which, $cmps, '-inf',0);
